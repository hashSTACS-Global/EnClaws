...
export type SessionEntry = {
  ...
  label?: string;
  displayName?: string;
  /** Formatted group/channel name generated by buildGroupDisplayName (e.g. "feishu:g-yan-fa-qun").
   * Set on group sessions only. displayName remains the IM user's real name. */
  groupName?: string;
  channel?: string;
  groupId?: string;
  subject?: string;
