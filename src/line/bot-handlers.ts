...
async function sendLinePairingReply(params: {
  ...
  const tenantContext = await resolveChannelTenantContext("line", context.account.accountId);
...
async function shouldProcessLineEvent(
  ...
  const tenantContext = await resolveChannelTenantContext("line", account.accountId);
