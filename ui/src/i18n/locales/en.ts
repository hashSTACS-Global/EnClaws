...
export const en: TranslationMap = {
  ...
  onboarding: {
    ...
    tierLabel: "Tier",
    tierHint: "Models are grouped by tier; callers can switch tiers per scene. Defaults to STANDARD. Adjust later on the Models page.",
  ...
  tenantAgents: {
    ...
    enabledTiers: "Enabled tiers",
    tierPickerHint: "Pick the tiers this agent can use; default/backup per tier follows the Models page config",
    tierDefaultShort: "Default ",
    tierBackupShort: "Backup ",
    tierNoBackup: "No backup configured for this tier; default failure returns an error",
    tierModelsCount: "{count} models",
    tierLegacyMark: "(unassigned — runs as STANDARD)",
  ...
  models: {
    ...
    addForm: {
      ...
      providerNameLabel: "Provider display name",
      baseUrlLabel: "Base URL",
      modelIdLabel: "Model ID",
      authModeLabel: "Auth mode",
      apiKeyLabel: "API key",
      pickTierFirst: "Pick a tier first, then a provider",
      submit: "Add",
      cancel: "Cancel",
      errorTierRequired: "Please pick a tier",
      errorProviderRequired: "Please pick a provider",
      errorProviderNameRequired: "Provider display name is required",
