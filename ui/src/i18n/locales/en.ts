...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    "tenant-apps": "Install and manage APP pipelines for this enterprise.",
  ...
  tenantApps: {
    ...
    subtitle: "Install, manage, and monitor APP pipelines.",
    refresh: "Refresh",
    loading: "Loading...",
    empty: "No APPs installed. Enter a Git URL above to install one.",
    gitUrlPlaceholder: "Git repository URL (e.g. https://github.com/org/my-app.git)",
    workspaceRepoPlaceholder: "Workspace repo URL (for runtime data)",
    ...
    pipelines: "Pipelines",
    pipelineCount: "{count} pipeline(s)",
    upgrade: "Upgrade",
    upgrading: "Upgrading...",
    upgradeSuccess: "APP \"{name}\" upgraded to {commit}.",
    configure: "Configure",
    configureSuccess: "APP \"{name}\" configured successfully.",
    save: "Save",
    saving: "Saving...",
