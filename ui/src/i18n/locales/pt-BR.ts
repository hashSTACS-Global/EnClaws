...
export const pt_BR: TranslationMap = {
  ...
  tenantAgents: {
    ...
    enabledTiers: "Categorias ativas",
    tierPickerHint: "Escolha as categorias que este agente pode usar; padrao/reserva por categoria seguem a pagina Modelos",
    tierDefaultShort: "Padrao ",
    tierBackupShort: "Reserva ",
    tierNoBackup: "Sem reserva para esta categoria; falha do padrao retorna erro",
    tierModelsCount: "{count} modelos",
    tierLegacyMark: "(sem categoria — roda como STANDARD)",
