...
export const de: TranslationMap = {
  ...
  tenantAgents: {
    ...
    tierPickerHint: "Waehle die Stufen, die dieser Agent nutzen darf; Standard/Backup pro Stufe folgt der Modelle-Seite",
    tierDefaultShort: "Standard ",
    tierBackupShort: "Backup ",
    tierNoBackup: "Kein Backup fuer diese Stufe; Fehler wird direkt zurueckgegeben",
    tierModelsCount: "{count} Modelle",
    tierLegacyMark: "(ohne Stufe — laeuft als STANDARD)",
