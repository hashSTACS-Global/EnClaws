...
export const de: TranslationMap = {
  ...
  onboarding: {
    ...
    selectTier: "Bitte zuerst eine Stufe waehlen",
    providerLabel: "Anbieter waehlen",
  ...
  tenantAgents: {
    ...
    tierSlotDefault: "Standard",
    tierSlotBackup: "Backup {n}",
    tierEmpty: "Keine Modelle in dieser Stufe",
