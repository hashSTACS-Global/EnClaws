...
export const zh_CN: TranslationMap = {
  ...
  tenantApps: {
    title: "应用管理",
    subtitle: "安装、管理和监控 APP 流水线。",
    refresh: "刷新",
    loading: "加载中...",
    empty: "暂无已安装的应用。在上方输入 Git 仓库地址来安装。",
    gitUrlPlaceholder: "Git 仓库地址（如 https://github.com/org/my-app.git）",
    workspaceRepoPlaceholder: "工作空间仓库地址（存放运行时数据）",
    ...
    pipelines: "流水线",
    pipelineCount: "{count} 条流水线",
    upgrade: "升级",
    upgrading: "升级中...",
    upgradeSuccess: "应用 \"{name}\" 已升级到 {commit}。",
    configure: "配置",
    configureSuccess: "应用 \"{name}\" 配置成功。",
    save: "保存",
    saving: "保存中...",
